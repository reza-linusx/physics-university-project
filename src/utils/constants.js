export const DEFINITIONS = {
  ...
  cylinder: {
    ...
    content:
      "استاندارد جرم استوانه ی پلاتین ایریدیوم است که در اداره ی بین المللی اوزان و مقیاس ها در پاریس نگهداری میشود.بنا بر این توافق جرم ۱ کیلوگرم به آن اختصاص داده شده است",
  },
};
